// Test script for drone fee in smart contract
...
const contractJSON = JSON.parse(
  fs.readFileSync(path.join(__dirname, 'artifacts/contracts/DeliveryEscrow.sol/DeliveryEscrow.json'), 'utf8')
);
...
async function testSmartContractDroneFee() {
  try {
